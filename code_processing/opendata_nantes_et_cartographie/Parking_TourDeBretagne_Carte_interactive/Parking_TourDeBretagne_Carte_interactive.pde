...
void mousePressed()
{
  ...
  if (mouseX>=xy[0]-parkingPictoTaille/2 && mouseX<=xy[0]+parkingPictoTaille/2 && mouseY>=xy[1]-parkingPictoTaille/2 && mouseY<=xy[1]+parkingPictoTaille/2)
  {
